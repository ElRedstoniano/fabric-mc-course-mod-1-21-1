...
public class WarturtleRenderer extends MobEntityRenderer<WarturtleEntity, WarturtleRenderState, WarturtleModel> {
    public WarturtleRenderer(EntityRendererFactory.Context context) {
        ...
        this.addFeature(new WarturtleArmorFeatureRenderer(this, context.getModelLoader(), context.getEquipmentRenderer()));
    }
