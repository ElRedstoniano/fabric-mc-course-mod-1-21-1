...
public class ModArmorMaterials {
    public static EquipmentModel FLUORITE = EquipmentModel.builder().addHumanoidLayers(MCCourseMod.id("fluorite")).build();
    ...
    }), 10, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 2.0F, 0.0F, ModTags.Items.REPAIRS_FLUORITE_ARMOR, EquipmentModels.DIAMOND);
