...
public class ModDataRegistryProvider extends FabricDynamicRegistryProvider {
    public ModDataRegistryProvider(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> registriesFuture) {
