...
public class ModEndBiomes {
    ...
    public static Biome endRot(RegistryEntryLookup<PlacedFeature> placedFeatureGetter, RegistryEntryLookup<ConfiguredCarver<?>> carverGetter) {
        ...
        /* //< 1.21.10 - Certain properties like waterFogColor, skyColor, fogColor and music are no longer under the biome effects builder
            //            Instead, now they are environment attributes ( e.g. Biome.Builder().setEnvironmentAttribute(EnvironmentAttributes.FOG_COLOR_VISUAL, -14989499) )
