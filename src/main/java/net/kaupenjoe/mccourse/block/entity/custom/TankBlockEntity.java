...
public class TankBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory<BlockPos>, ImplementedInventory {
    ...
    public Text getDisplayName() {
        return Text.translatable("gui.mccourse.tank");
    }
    ...
    private boolean hasFluidStackInSecondSlot() {
        return inventory.get(1).getCount() == 1 && !inventory.get(1).isEmpty() && FluidUtils.isContainer(inventory.get(1))
